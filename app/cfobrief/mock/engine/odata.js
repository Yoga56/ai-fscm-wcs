...
/** Engine result -> { Brief, RunwayDay[], Risk[], TradeOff[] } rows */
function snapshot(result, briefUuid = uuid("b0000001")) {
  ...
  return {
    ...
    Risk: result.risks.map((r) => pick("Risk", { ...r, RiskUuid: uuid("r0000001"), BriefUuid: briefUuid, Currency: cur, HasDraft: false, AiNote: "", LocalLastChangedAt: ts })),
