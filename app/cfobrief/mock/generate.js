...
write("RankedRisk", rows.RankedRisk);
write("TradeOff", rows.TradeOff);
write("ActionDraft", []);

console.log(`mock data: 1 brief, ${rows.RunwayDay.length} days, ${rows.RankedRisk.length} risks, ${rows.TradeOff.length} advice rows`);
